...
using Workshop.Network.Api.Db;

namespace Workshop.Network.Api
{
    public class Startup
    {
       // This method gets called by the runtime. Use this method to add services to the container.
        ...
        {
            services.AddPooledDbContextFactory<NetworkContext>(options => 
                ...
                .AddGraphQLServer()
                    ...
                    (
                        c => c
                            ...
                            .SetName(WorkshopConfig.NetworkSchemaName)
                            .PublishToRedis
                            (
