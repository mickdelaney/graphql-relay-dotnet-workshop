...
type Props = {
  sidebarNavigation: Array<LinkState>;
  userNavigation: Array<LinkState>;
};

export const Shell: FunctionComponent<Props> = ({ children, sidebarNavigation, userNavigation }) => {
